...
namespace CompendiumMapCreator.Controls
{
	...
	/// to be used:
	///
	///     xmlns:MyNamespace="clr-namespace:CompendiumMapCreator.Controls"
	///
	///
	...
	/// to be used:
	///
	///     xmlns:MyNamespace="clr-namespace:CompendiumMapCreator.Controls;assembly=CompendiumMapCreator.Controls"
	///
